...
func (a CoreAttribute) validateSingular(attribute interface{}) (interface{}, *errors.ScimError) {
	...
	case attributeDataTypeBoolean:
		// Attempt to convert the stringified attribute instead of asserting it
		// to a bool. Microsoft Azure AD currently sends the boolean attribute
		// "active" as string values ("True" and "False") which cannot be
		// asserted to a Golang bool.
